...
namespace Sismeing.Service.Interfaces.Operaciones
{
    public interface IMedicionService
    {
        ...
        Task<IEnumerable<Medicion>> GetByInformeAsync(int informeId, int equipoId);
        ...
        Task<IEnumerable<Medicion>> ReemplazarPorInformeAsync(int informeId, int equipoId, IEnumerable<Medicion> items, string usuarioRegistro);
