...
namespace Sismeing.API.Controllers.Catalogo
{
    [Authorize]
    [ApiController]
    [Route("api/tipo-mantenimiento")]
    public class TipoMantenimientoController : ControllerBase
    {
        private readonly SupaBaseDBcontext _context;

        public TipoMantenimientoController(SupaBaseDBcontext context) => _context = context;

        [HttpGet]
        public async Task<ActionResult<IEnumerable<TipoMantenimiento>>> GetAll()
            => Ok(await _context.TiposMantenimiento.Where(t => t.Activo).ToListAsync());

        [HttpGet("{id:int}")]
        public async Task<ActionResult<TipoMantenimiento>> GetById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<TipoMantenimiento>> Create([FromBody] TipoMantenimiento tipo)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] TipoMantenimiento tipo)
        {
